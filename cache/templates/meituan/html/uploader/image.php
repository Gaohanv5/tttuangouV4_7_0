...
<input id="fileUploaderButton" type="button" value="开始上传" style="position:relative; bottom:14px;*bottom:12px; width:100px;height:25px;font-weight:bold;font-size:14px; " />
</div>
